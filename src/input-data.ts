...
const rgr2 = [
  ...
  null,
  {
    1: {
      ...
      xi1: 1.03,
      hValue: 0.09,
      arrN: [5, 3, 3, 12, 11, 13, 3],
      specX: 1.34,
      sko: 0.14,
      significanceLevel: 0.05,

      /* xPircon, t и rounding - изменяемое */
      xPirson: 9.49,
      tValue: 1.96,
      rounding: 2,
    },
    2: {
      type: 'connection',
      title: 'Метание ядра 6кг снизу вперед',
      x1Arr: [10.0, 9.5, 10.9, 11.0, 8.4, 9.8, 10.7, 10.2],
      x2Arr: [9.2, 8.7, 10.3, 7.9, 9.4, 10.7, 10.9, 11.2],
